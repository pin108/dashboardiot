    ...
    <body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="{{ url('menu/daerah') }}" aria-expanded="false" aria-controls="ui-basic">
                ...
                <div class="collapse" id="ui-basic">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/pati') }}">Pati</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/demak') }}">Demak</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/brebes') }}">Brebes</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/tegal') }}">Tegal</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/boyolali') }}">Boyolali</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/kendal') }}">Kendal</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('menu/daerah/temanggung') }}">Temanggung</a></li>
                    </ul>
                </div>
                </li>
                <li class="nav-item">
