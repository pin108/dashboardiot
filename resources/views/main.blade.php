    ...
    <body>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{ asset('style/template/images/logoudinus.png') }}" class="mr-2" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('style/template/images/logoudinus.png') }}" alt="logo"/></a>
            </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                    <a class="dropdown-item"> <x-slot name="content">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <ul class="nav">
                ...
                <div class="collapse" id="ui-basic">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="#">Pati</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Demak</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Brebes</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Tegal</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Boyolali</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Kendal</a></li>
                    <li class="nav-item"> <a class="nav-link" href="#">Temanggung</a></li>
                    </ul>
                </div>
                </li>
                <li class="nav-item">
            ...
            <div class="content-wrapper">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-people mt-auto">
                        <img src="{{ asset('style/template/images/dashboard/people.svg') }}" alt="people">
                        <div class="weather-info">
                        <div class="d-flex">
                            <div>
                            <h2 class="mb-0 font-weight-normal"><i class="icon-sun mr-2"></i>35<sup>C</sup></h2>
                            </div>
                            <div class="ml-2">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                        <iframe style="height:80%;width:80%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=semarang&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
                        <a class="my-codefor-googlemap" rel="nofollow" href="https://www.bootstrapskins.com/themes" id="authorize-map-data"></a>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="http://compute.dinus.ac.id:900/api/tabel/export"><button type="button" class="btn btn-primary">Download Data</button></a>
                            ...
                            <div class="row">
                               ...
                               {{-- @foreach($data as $dataiot) --}}
                                <p class="card-title">Laporan IoT Sensor</p>
                                    ...
                                    <h3 class="font-weight-500 mb-xl-4 text-primary">Brebes</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive mb-3 mb-md-0 mt-3">
                                        ...
                                        <tr>
                                            <td class="text-muted">Data Kelembaban Tanah</td>
                                            <td class="w-100 px-0">
                                            <div class="progress progress-md mx-4">
                                                <div class="progress-bar bg-warning" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            </td>
                                            <td><h5 class="font-weight-bold mb-0">8</h5></td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">Ph Tanah</td>
                                            <td class="w-100 px-0">
                                            <div class="progress progress-md mx-4">
                                                <div class="progress-bar bg-success" role="progressbar" style="width: 95%" aria-valuenow="5" aria-valuemin="0" aria-valuemax="7"></div>
                                            </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="text-muted">Data Kecepatan Angin</td>
                                            <td class="w-100 px-0">
                                            <div class="progress progress-md mx-4">
                                                <div class="progress-bar bg-primary" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            </td>
                                            <td><h5 class="font-weight-bold mb-0">34</h5></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><h5 class="font-weight-bold mb-0">Hidup</h5></td>
                                        </tr>
                                        </table>
                                    </div>
                                    </div>
            ...
            <footer class="footer">
                ...
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">IoT dashboard</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Developer Team IoT <i class="ti-heart text-danger ml-1"></i></span>
                </div>
            </footer>
            <!-- partial -->
            </div>
